...
func _ready():
	var max_slope_angle = 50.0
	var skin: Spatial = $Skin
	var player_doll: Spatial = $Skin/PlayerDoll
	var camera: ControllableCamera = $CamRoot/ControllableCamera
	var controls: Controls = $Controls
	var anim_tree: AnimationTree = $Skin/AnimationTree
	var vfx_dash: Particles = $Skin/VfxDash
	var vfx_surge: Particles = $Skin/VfxSurge
	var sm_movement: StateMachine = $Movement
	var water_surface_detector: Area = $WaterSurfaceDetector
